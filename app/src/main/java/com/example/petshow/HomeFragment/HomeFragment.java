package com.example.petshow.HomeFragment;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnCampInfo = homeView.findViewById(R.id.btnCampInfo);
        Button btnFundInfo = homeView.findViewById(R.id.btnFundInfo);
        btnCampInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), CampInfo.class);
                startActivity(intent);
            }
        });
        btnFundInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
